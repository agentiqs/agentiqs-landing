      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Explore practical examples of how mcp-kit simplifies AI agent
            development.
          </p>
        </div>
            ...
            <Tabs defaultValue="main" className="w-full">
              <div className="flex items-center justify-between px-6 pt-4 pb-2">
                <TabsList className="bg-ai-blue/50 border border-white/20">
                  <TabsTrigger
                    value="main"
                    className="text-white data-[state=active]:bg-ai-electric data-[state=active]:text-white"
                  >
                    {codeExamples.main.title}
                  </TabsTrigger>
                  <TabsTrigger
                    value="config"
                    className="text-white data-[state=active]:bg-ai-electric data-[state=active]:text-white"
                  >
                    {codeExamples.config.title}
                  </TabsTrigger>
                  <TabsTrigger
                    value="env"
                    className="text-white data-[state=active]:bg-ai-electric data-[state=active]:text-white"
                  >
                    {codeExamples.env.title}
                  </TabsTrigger>
                </TabsList>
